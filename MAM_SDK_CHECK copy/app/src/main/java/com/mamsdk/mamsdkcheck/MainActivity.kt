...
import com.microsoft.intune.mam.client.app


class MainActivity : AppCompatActivity() {

    companion object {
        var isIntuneSDKEnabled = true // Set this to false to disable the SDK
    }
    ...
    private fun initializeIntuneSDK(userName: String) {
        val mamEnrollmentManager = MAMEnrollmentManager.getInstance()

        MAMEnrollmentManager
        mamEnrollmentManager.setMAMEnrollmentEnabled(true)
    }
